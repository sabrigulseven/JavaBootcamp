<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.List , java.io.InputStream , org.w3c.dom.*, 
...
String categoryName=products.get(0).getCategory().getCategoryName();
%>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="card w-100">
					...
					<div class="card-body">
						...
						<div class="mt-3 d-flex justify-content-between">
							...
							<a class="btn btn-primary" href="order-now?quantity=1&id=<%=p.getProductId()%>">Buy Now</a>
						</div>
					</div>
				</div>
			</div>
